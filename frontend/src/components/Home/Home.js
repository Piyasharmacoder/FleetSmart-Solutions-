            ...
            <div className="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
              <div className="col-12 col-lg-6 d-flex justify-content-center align-items-center bg-transparent">
                <Carousel activeIndex={index} onSelect={handleSelect} interval={1000} controls={false} >
                  <Carousel.Item>
                    <img className="d-block" src="image/jcb.png" alt="..." style={{ objectFit: 'cover', height: "30vw" }} />
                  </Carousel.Item>
                  <Carousel.Item>
                    <img className="d-block" src="image/truck.png" alt="..." style={{ objectFit: 'cover', height: "30vw" }} />
                  </Carousel.Item>
                  <Carousel.Item>
                    <img className="d-block" src="image/roadroler.png" alt="..." style={{ objectFit: 'cover', height: "30vw" }} />
                  </Carousel.Item>
                  <Carousel.Item>
                    <img className="d-block" src="image/loader.png" alt="..." style={{ objectFit: 'cover', height: "30vw" }} />
                  </Carousel.Item>
                  <Carousel.Item>
                    <img className="d-block" src="image/dumptruck.png" alt="..." style={{ objectFit: 'cover', height: "30vw" }} />
                  </Carousel.Item>
                  <Carousel.Item>
                    <img className="d-block" src="image/tractor.png" alt="..." style={{ objectFit: 'cover', height: "30vw" }} />
                  </Carousel.Item>
                  <Carousel.Item>
                    <img className="d-block" src="image/crane.png" alt="..." style={{ objectFit: 'cover', height: "30vw" }} />
                  </Carousel.Item>
                </Carousel>
              </div>
                      ...
                      <div className="frontside p-0 m-3">
                        <div className="card">
                          <div className="card-body text-center p-0 m-0 ">
                            <p className=' p-0 m-0'><img className="p-0 m-0" height={150} src={item.imageUrl} alt="card" /></p>

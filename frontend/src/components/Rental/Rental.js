        ...
        <div className="card shadow border p-3">
          <div className="row no-gutters">
            <div className="col-md-5 d-flex align-items-center">
              <img className="card-img" src={state.image} alt={state.model} />
            </div>
            ...
            <form className="container p-0" onSubmit={handleSubmit}>
              ...
              <div className="form-row d-flex flex-wrap justify-content-between">
                ...
                <div className="form-group col-md-3 my-2">
                  <label>Time</label>
                  <select
                    className="form-control form-control-sm bg-transparent border-dark w-auto"
                    value={duration}
              ...
              <div className="form-group my-2">
                ...
                <input
                  ...
                  placeholder="1234 Main Street, Indore"
                  value={address}

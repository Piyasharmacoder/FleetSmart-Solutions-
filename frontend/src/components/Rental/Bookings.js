...
const Bookings = () => {
    ...
    useEffect(() => {
        axios.post('http://localhost:3001/rental/fetchRentalItems', { userId })
            .then(response => {
                console.log(response.data.data[0].Vehicles);
    ...
    <ToastContainer />
            {
                ...
                {vehicles.length > 0 ? vehicles.map((item, index) => (
                            ...
                            <div className="row no-gutters">
                                ...
                                <div className="col-md-7 d-flex align-items-center">
                                    <div className="card-body p-0">
                                        ...
                                        <p className="card-text m-1"><img src="https://png.pngtree.com/png-clipart/20220429/original/pngtree-pin-location-icon-with-folded-map-png-image_7581594.png" height={40}/><small className="text-muted">{item.RentalItems.work_place}</small></p>
                                        <sapn className="card-text m-1">Date Of Booking :</sapn>
                                        <DateTimePicker
                                          value={item.RentalItems.date}
                    ...
                    <div className='container-fluid d-flex p-4 justify-content-center align-content-center ' id='blackCart'>
                        <div>
                            <img width={'450px'} height={'300px'} src="https://cdni.iconscout.com/illustration/premium/thumb/couple-booking-new-car-illustration-download-in-svg-png-gif-file-formats--communication-conversation-talking-chatting-showroom-pack-services-illustrations-2438532.png" alt="..."/>
                            <h6 className='text-center'>Your Bookings is empty!</h6>

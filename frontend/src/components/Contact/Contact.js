              ...
              <div className="card rounded shadow overflow-hidden">
                <div className="card-body p-0">
                  <div className="row gy-3 gy-md-4 gy-lg-0">
                    <div className="col-12 col-lg-6 bsb-overlay background-position-center background-size-cover" style={{ '--bsb-overlay-opacity': '0.7', backgroundImage: "url('https://cf-img-a-in.tosshub.com/sites/visualstory/stories/2022_12/story_15675/assets/1.jpeg?time=1671524886')" }}>
                            ...
                            <div className="row gy-4 gy-xl-5 p-4 p-xl-5">
                              ...
                              <div className="col-12">
                                <div className="d-grid">
                                  <button className="btn btn-success btn-lg" type="submit">Send Message</button>
                                </div>
                              </div>
                            </div>
                          </form>

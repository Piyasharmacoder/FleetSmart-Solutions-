              ...
              <div class="card rounded shadow overflow-hidden">
                <div class="card-body p-0">
                  <div class="row gy-3 gy-md-4 gy-lg-0">
                    <div class="col-12 col-lg-6 bsb-overlay background-position-center background-size-cover" style={{ '--bsb-overlay-opacity': '0.7', backgroundImage: "url('https://cf-img-a-in.tosshub.com/sites/visualstory/stories/2022_12/story_15675/assets/1.jpeg?time=1671524886')" }}>
